...
GO
PRINT N'Dropping [dbo].[FK_NinjaHasGear_Gear]...';


GO
ALTER TABLE [dbo].[NinjaHasGear] DROP CONSTRAINT [FK_NinjaHasGear_Gear];


GO
PRINT N'Dropping [dbo].[FK_NinjaHasGear_Ninja]...';


GO
ALTER TABLE [dbo].[NinjaHasGear] DROP CONSTRAINT [FK_NinjaHasGear_Ninja];


GO
PRINT N'Starting rebuilding table [dbo].[NinjaHasGear]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_NinjaHasGear] (
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[NinjaHasGear])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_NinjaHasGear] ([NinjaId], [GearId])
        SELECT   [NinjaId],
                 [GearId]
        FROM     [dbo].[NinjaHasGear]
        ORDER BY [NinjaId] ASC, [GearId] ASC;
    END

DROP TABLE [dbo].[NinjaHasGear];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_NinjaHasGear]', N'NinjaHasGear';
...
GO
ALTER TABLE [dbo].[NinjaHasGear] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[NinjaHasGear] WITH CHECK CHECK CONSTRAINT [FK_NinjaHasGear_Gear];

ALTER TABLE [dbo].[NinjaHasGear] WITH CHECK CHECK CONSTRAINT [FK_NinjaHasGear_Ninja];
