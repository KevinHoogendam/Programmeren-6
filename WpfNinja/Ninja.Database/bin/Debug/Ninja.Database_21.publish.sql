...
GO
PRINT N'Rename refactoring operation with key a7e1976e-92f3-403f-8d3c-949da7dbdf95 is skipped, element [dbo].[Gear].[agility] (SqlSimpleColumn) will not be renamed to Agility';


GO
-- Refactoring step to update target server with deployed transaction logs
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'a7e1976e-92f3-403f-8d3c-949da7dbdf95')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('a7e1976e-92f3-403f-8d3c-949da7dbdf95')
